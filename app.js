...
var taskInput =
  document.getElementById("new__task"); //Add a new task.
var addButton =
...
var createNewTaskElement = function (taskString) {
  ...
  //button.edit
  var editButton =
    document.createElement("button"); //edit button

  //button.delete
  var deleteButton =
    document.createElement("button"); //delete button
  var deleteButtonImg =
    document.createElement("img"); //delete button image

  deleteButtonImg.className = "delete__image";
  listItem.className = "todo__list__task";

  label.innerText = taskString;
  label.className = "task__name"; //todo !!

  //Each elements, needs appending
  checkBox.type = "checkbox";
  checkBox.className = "task__check";
  editInput.type = "text";
  editInput.className = "task__input"; //todo !!
...
var editTask = function () {
  ...
  var editBtn = listItem.querySelector(
    ".task__btn-edit",
  );
  var containsClass = listItem.classList.contains(
    "todo__list__task--editing",
  );
...
var bindTaskEvents = function (
  ...
  var editButton = taskListItem.querySelector(
    "button.task__btn-edit",
  );
  var deleteButton = taskListItem.querySelector(
    "button.task__btn-delete",
  );
